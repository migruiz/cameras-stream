...
of(sensorEvent).pipe(
    map(event => Object.assign({durationSecs:Math.round(parseFloat(event.videoDuration/1000))}, event)),
    map(event => Object.assign({joinedStartAtMilis:event.startVideoAt - event.videosStartTime}, event)),
